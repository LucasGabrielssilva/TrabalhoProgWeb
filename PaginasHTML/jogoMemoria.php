...
<body>
  ...
  <main>
    ...
    <section id="seletor-modo">
        <h2>Selecione o Modo</h2>
         <button id="btn-modo-classico" onclick="setModoJogo('Clássico')" data-modo="Clássico" class="ativo">Clássico</button>
        <button id="btn-modo-tempo" onclick="setModoJogo('Contra o Tempo')" data-modo="Contra o Tempo">Contra o Tempo</button>
    </section>
  ...
  <script src="../JavaScript/jogoMemoria.js"></script>
